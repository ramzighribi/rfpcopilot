          ...
          <Dialog open={isBatchRegenDialogOpen} onOpenChange={setIsBatchRegenDialogOpen}>
            ...
            <DialogContent className="max-w-lg" onInteractOutside={(e) => { if(isBatchRegenerating) e.preventDefault() }}>
              ...
              {isBatchRegenerating ? (
                ...
                <>
                  <div className="space-y-4 py-4">
                    <div className="space-y-2"><Label>{t('responseLanguage')}</Label><RadioGroup value={batchRegenParams.language} onValueChange={(v) => setBatchRegenParams({...batchRegenParams, language: v})}><div className="flex items-center space-x-2"><RadioGroupItem value="Français" id="br-lang-fr" /><Label htmlFor="br-lang-fr">{t('french')}</Label></div><div className="flex items-center space-x-2"><RadioGroupItem value="Anglais" id="br-lang-en" /><Label htmlFor="br-lang-en">{t('english')}</Label></div><div className="flex items-center space-x-2"><RadioGroupItem value="Espagnol" id="br-lang-es" /><Label htmlFor="br-lang-es">{t('spanish')}</Label></div><div className="flex items-center space-x-2"><RadioGroupItem value="Italien" id="br-lang-it" /><Label htmlFor="br-lang-it">{t('italian')}</Label></div></RadioGroup></div>
                    <div className="space-y-2"><Label>{t('responseLength')}</Label><RadioGroup value={batchRegenParams.responseLength} onValueChange={(v) => setBatchRegenParams({...batchRegenParams, responseLength: v})}><div className="flex items-center space-x-2"><RadioGroupItem value="Courte" id="br-len-s" /><Label htmlFor="br-len-s">{t('short')}</Label></div><div className="flex items-center space-x-2"><RadioGroupItem value="Moyenne" id="br-len-m" /><Label htmlFor="br-len-m">{t('medium')}</Label></div><div className="flex items-center space-x-2"><RadioGroupItem value="Longue" id="br-len-l" /><Label htmlFor="br-lang-l">{t('long')}</Label></div></RadioGroup></div>
                    <div className="space-y-2">
                      <Label>{t('persona')}</Label>
